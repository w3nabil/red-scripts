        ...
        if subjectchoice == int(1):
            while True:
                ...
                if os.path.exists(f'./src/{customsubjectfile}.txt'):
                    ...
                    subjectfile = f"./src/{customsubjectfile}.txt"
                    break
                else:
            ...
            with open('./src/mailsubject.txt', 'w') as file:
                for i in range(int(AttackRange)):
                    ...
                    file.write(Subject+'\n')
                file.close()
            subjectfile = "./src/mailsubject.txt"
            break
        else:
        ...
        if bodychoice == int(1):
            while True:
                ...
                if os.path.exists(f'./src/{custombodyfile}.txt'):
                    ...
                    bodyfile = f"./src/{custombodyfile}.txt"
                    break
                else:
                    print("File not found! Please enter a valid file name.")
...
# Senders = read_file('./src/mailsender.txt')
